...
yum install ruby-devel openssl-devel.x86_64 postgresql-devel.x86_64 postgresql-server postgresql-contrib rubygem-thin httpd sudo systemd zlib-devel readline-devel redhat-rpm-config -y
